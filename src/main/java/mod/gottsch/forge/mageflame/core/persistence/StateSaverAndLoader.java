...
public class StateSaverAndLoader extends SavedData {
    ...
    public static StateSaverAndLoader create() {
...
//        MageFlame.LOGGER.info("loading persistent data ie players");
    ...
    public static StateSaverAndLoader get(Level level) {
        ...
        StateSaverAndLoader data = (StateSaverAndLoader) storage.computeIfAbsent(StateSaverAndLoader::load,
                StateSaverAndLoader::create, MageFlame.MOD_ID);
        data.setDirty();
        return data;
    }
