...
import mod.gottsch.forge.mageflame.core.client.model.entity.BubbleFlameModel;
import mod.gottsch.forge.mageflame.core.client.renderer.entity.layers.BubbleFlameGlowLayer;
import mod.gottsch.forge.mageflame.core.client.renderer.entity.layers.GreaterRevelationGlowLayer;
import mod.gottsch.forge.mageflame.core.entity.creature.BubbleFlameEntity;
...
public class BubbleFlameRenderer<T extends BubbleFlameEntity> extends MobRenderer<T, BubbleFlameModel<T>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MageFlame.MOD_ID, "textures/entity/bubble_flame.png");
