...
//    }
    ...
    @Override
    public void appendHoverText(ItemStack stack, Level context, List<Component> tooltip, TooltipFlag type) {
    ...
    //	@Override
    public void appendBaseText(ItemStack stack, Level context, List<Component> tooltip, TooltipFlag type) {
    ...
    //	@Override
    public void appendAdvancedText(ItemStack stack, Level context, List<Component> tooltip, TooltipFlag type) {
        appendLore(stack, context, tooltip, "glowglob.lore");
    }

    public void appendLore(ItemStack stack, Level context, List<Component> tooltip, String key) {
