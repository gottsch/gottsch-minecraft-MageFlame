...
public interface ISummonScrollItem {
	...
	default public void appendBaseText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag type) {
	}

	default public void appendAdvancedText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag type) {
	}

	default public void appendLore(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag type, String key) {
