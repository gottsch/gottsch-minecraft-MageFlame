...
//        this.lifespan =lifespan;
    ...
    public static class FollowOwnerGoal extends Goal {
        ...
        public void start() {
            ...
            this.oldWaterPathfindingPenalty = this.lightSourceEntity.getPathfindingMalus(BlockPathTypes.WATER);
            this.lightSourceEntity.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        }

        public void stop() {
            this.owner = null;
            this.navigation.stop();
            this.lightSourceEntity.setPathfindingMalus(BlockPathTypes.WATER, this.oldWaterPathfindingPenalty);
        }
