...
import mod.gottsch.forge.mageflame.core.entity.creature.SummonedPathAwareEntity;
...
public class EmberHoundModel<T extends SummonedPathAwareEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MageFlame.MOD_ID, "ember_hound"), "main");
