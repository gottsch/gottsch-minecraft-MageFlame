 ...
 */
package mod.gottsch.forge.mageflame.core.persistence;

import com.google.common.collect.Maps;
import mod.gottsch.forge.gottschcore.spatial.Coords;
import mod.gottsch.forge.gottschcore.spatial.ICoords;
import mod.gottsch.forge.mageflame.core.util.ModUtil;
...
public class PlayerData {
    ...
    public CompoundTag writeNbt(CompoundTag nbt) {
        entityRegistry.forEach((key, value) -> {
            ...
            data.putString("type", ForgeRegistries.ENTITY_TYPES.getKey(value.getEntityType()).toString());
    ...
    public void loadNbt(CompoundTag nbt) {
        nbt.getAllKeys().forEach(key -> {
            ...
            if (summonedNbt.contains("type")) {
                EntityType entityType = ForgeRegistries.ENTITY_TYPES.getValue(ModUtil.asLocation(summonedNbt.getString("type")));
