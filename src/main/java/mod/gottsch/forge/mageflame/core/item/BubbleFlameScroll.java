...
public class BubbleFlameScroll extends SummonFlyingScrollItem {
	...
	@Override
	public void appendBaseText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag type) {
	...
	@Override
	public void appendAdvancedText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag type) {
		appendLore(stack, level, tooltip, type,"bubble_flame.lore");
	}
}
